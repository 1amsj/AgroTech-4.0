              ...
              <div class="col-md-6">
                <form id="f2" method="post">
                  <div class="mb-3">
                    ...
                    <input class="form-control input-standar" readonly type="text" id="userm" name="userm" placeholder="Introducir n° de empleado" autofocus>
                  </div>
                  <div class="mb-3">
                    <label for="password">Ingrese nombre del empleado</label>
                    <span id="snombrem" class="text-danger"></span>
                    <input class="form-control input-standar" type="text" id="nombrem" name="nombrem" placeholder="Escrba su nombre">
                  </div>
                  <div class="mb-3">
                    <label for="apellidom">Ingrese apellidom del empleado</label>
                    <span id="sapellidom" class="text-danger"></span>
                    <input class="form-control input-standar" type="text" id="apellidom" name="apellidom" placeholder="Escrba su apellido">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control input-standar" type="text" id="contraseñam" name="contraseñam" placeholder="Digite su contraseña">
                    <input style="display: none;" type="text" name="modificar" value="registrar">
                  </div>
                  <button type="button" class="btn w-100" id="modificar">guardar</button>
                </form>
              </div>
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content">
      ...
      <form id="f3" method="post" >
                    ...
                    <input class="form-control input-standar" readonly type="text" id="eliminar" name="eliminar" placeholder="Introducir n° de empleado" autofocus>
